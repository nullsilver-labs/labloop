...
| served models (sessions) | claude-haiku-4-5-20251001|claude-sonnet-5: 19 | claude-haiku-4-5-20251001|claude-sonnet-5: 19; : 1 |
...
Mechanical pending reasons: served models differ between the arms.
